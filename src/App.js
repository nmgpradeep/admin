    ...
    return (
      <HashRouter>
        <Switch>
          ...
          <Route exact path="/resetPassword" exact name="admin Login Page" component={ResetPassword} />
          <Route exact path="/checkMail" exact name="admin Login Page" component={CheckMail} />
